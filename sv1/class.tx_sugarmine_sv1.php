...
/**
 * Service "SugarMineAuthentication" for the "sugarmine" extension.
 *
 * @author	 <Sebastian Stein>
 * @package	TYPO3
 * @subpackage	tx_sugarmine
 */
class tx_sugarmine_sv1 extends t3lib_svbase {
				var $prefixId = 'tx_sugarmine_sv1';		// Same as class name
				var $scriptRelPath = 'sv1/class.tx_sugarmine_sv1.php';	// Path to this script relative to the extension dir.
	 ...
	 */
				function process($content='', $type='', $conf=array())	{
					...
					//return FALSE;
					$dispatcher = t3lib_div::makeInstance('Tx_SugarMine_ServiceDispatcher');
